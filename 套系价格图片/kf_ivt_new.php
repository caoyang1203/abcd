	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www10.53kf.com/webCompany.php?arg=9006032&style=1&kflist=off&kf=cxl897224372%40163.com%2Crome2014%40163.com%2Clmfq2014%40163.com%2Cbjlmfq2014%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F27.haiwaisheying.com%2Findex&keyword=http%3A%2F%2Fwww.bjlmfq.com%2F&brief=&logo=&question=&uid=410eb48aee89afb73731c3d8c665ca6e";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "1";
			var ivtstr						= "<div id=\"inv_box_53kf\" style=\"width: 380px; padding-top: 10px; padding-left: 10px; box-sizing: border-box; position: fixed; left:412px; top:22px;display: block;z-index:999998;\"><div style=\"position:absolute;left:0;top:0;width:20px;height:20px;cursor:pointer;z-index:5;\" onclick = \"inv.clos()\"><img style=\"width:100%;height:100%;\" src=\"https://talk.71baomu.com/style/setting/ver07/img/style_mobile_invite/close_2x.png\"></div><div class=\"inv_bg_color\" style=\"width:100%;box-sizing: border-box;overflow:hidden;background:#FFFFFF; border:1px solid #eee; box-shadow: 2px 0 15px 5px #eee;border-radius: 2px;\"><div class=\"img_bg\" style=\"background:url(https://obs-hwe2-p2.obs.cn-east-2.myhwclouds.com/upfile/70801396/15436540823329.jpg);background-size: 100% 100%; width: 100%;height: 140px;\"></div><div style=\"padding:16px 16px 24px 16px;overflow: hidden\"><div class=\"inv_title\" style=\"font-size:22px;text-align:center;float:left;width:100%;line-height:32px;margin-bottom:8px;letter-spacing:1px;box-sizing:border-box;color:#3A3C4C;\">欢迎光临27°罗马风情</div><div class=\"inv_content\" style=\"font-size: 14px; line-height: 20px;  text-align: left; max-height: 60px; overflow: auto; float: left; width: 100%; margin-bottom: 16px; word-wrap: break-word; color: #3A3C4C;\"></div><div class=\"talk_btn\" style=\"float:left;width:100%;border-radius:2px;height:44px;line-height:44px;letter-spacing: 0.83px;font-size:16px;text-align:center;cursor:pointer;color:#FFFFFF;background:#1F8CEB;\" onclick=\"inv.talk()\">点击咨询</div></div></div></div>";
			var is_autoyqk				= "1";
			var once_autoyqk            = 0;//邀请语开关
			var zdyivt_width			= "450px";
			var zdyivt_height		 = "230px";
			var acc_reinvite			= "1";
			var acc_reauto				= "1";
		...
		//	var acc_poptype			 = -1;
			...
			var pc_ivt_top = "40";
			var pc_ivt_left = "50";
			var callback_id6ds = "10087111,10069831,10069826,10069827,10069830";
			...
			if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			    		...
			    		Inv.prototype = {
			    			...
			    			talk : function(){
			    				...
			    				if (zdfq_type == 3) {
			    					...
			    					var openurl = "https://www10.53kf.com/webCompany.php?arg=9006032&style=1&kflist=off&kf=cxl897224372%40163.com%2Crome2014%40163.com%2Clmfq2014%40163.com%2Cbjlmfq2014%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F27.haiwaisheying.com%2Findex&keyword=http%3A%2F%2Fwww.bjlmfq.com%2F&brief=&logo=&question=&uid=410eb48aee89afb73731c3d8c665ca6e&tfrom=2" + force_kf;
			    					onliner_zdfq=2;
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="https://www10.53kf.com/img/upload/9006032/mobile/temp/mobile_53kf_1511085162.jpg"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
                    ...
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('https://www10.53kf.com/style/chat/minichat2/img/header_bg2_9.png')";
				}
				else
				{
				...
				}                   $53("mini_header_bg_div").style.backgroundImage = "url('https://www10.53kf.com/style/chat/minichat2/img/header_bg_9.png')";
			...
			{
				if(zdfq_switch == 'yes') {
					//document.cookie = "onliner_zdfq70801396="+onliner_zdfq;
					document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
				} else {
					document.cookie = "my_acc_reauto_time=null;path=/";
				}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				try{
					...
					if(type==1){
						...
						if('1' == 0){
							...
							$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=9&interface_theme=3&minchat_style=1';
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq70801396="+onliner_zdfq;}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"https://www10.53kf.com/webCompany.php?arg=9006032&style=1&kflist=off&kf=cxl897224372%40163.com%2Crome2014%40163.com%2Clmfq2014%40163.com%2Cbjlmfq2014%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F27.haiwaisheying.com%2Findex&keyword=http%3A%2F%2Fwww.bjlmfq.com%2F&brief=&logo=&question=&uid=410eb48aee89afb73731c3d8c665ca6e&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www10.53kf.com/webCompany.php?arg=9006032&style=1&kflist=off&kf=cxl897224372%40163.com%2Crome2014%40163.com%2Clmfq2014%40163.com%2Cbjlmfq2014%40163.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2F27.haiwaisheying.com%2Findex&keyword=http%3A%2F%2Fwww.bjlmfq.com%2F&brief=&logo=&question=&uid=410eb48aee89afb73731c3d8c665ca6e&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=70801396&style_id=103749168\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
